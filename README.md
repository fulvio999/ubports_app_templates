...
**-AdaptiveLayout:** to create an application based on ContentHub to import images from the Apps registered as Images source on your device.
(With little changes can be adapted import other contents types).
For more technical comments and information, please look at the source code.
